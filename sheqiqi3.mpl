        ...
        for mod_index from 1 by 1 to mod_total do
            ...
            for counter from 1 by 1 to solutions do
                ...
                if (max_ele_level = 1) then 
                    ...
                    p(plot_counter) := pointplot(modulation,angles[mod_index,1,counter,1],axis = [gridlines],view=[2..3.3, 0..90],symbol=soliddiamond,color = [ColorTools:-Color("Gold"),ColorTools:-Color("Crimson"),ColorTools:-Color("OliveDrab"),ColorTools:-Color("coral"),"Purple",ColorTools:-Color("Indigo"), ColorTools:-Color("ForestGreen"),ColorTools:-Color("PaleVioletRed"),ColorTools:-Color("CadetBlue")]):
                    break:
                end if:
